...
const str3: string = "Hello, I am from quarter-1.";
const str4: string = "hello, i am from quarter-1.";
...
const cricketItems:string[]=["Bat","Ball","Pads","Helmet"];
...
const flowers:string[]=["rose", "tulip", "daffodil", "lilly"];
