...
const current_users:string[]=["Umair", "Ashraf", "Ali", "Qamar", "Burhan", "Arham"];

const new_users:string[]=["qamar", "arham", "ahmed", "abdul", "buraq"];
...
function checkUserNames(current_users:string[],new_users:string[]): void{
    ...
    for (const newUser of new_users){
        ...
        if(lowercasedCurrentUsers.includes(lowecaseNewUser)){
